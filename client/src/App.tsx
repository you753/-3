...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // إذا فتح المستخدم الصفحة الرئيسية أو صفحة تسجيل الدخول، امسح وضع الفرع المباشر
    ...
    // لكن فقط إذا كان في صفحة فرع فعلاً
    if (isDirectBranchAccess && directBranchId && !isDirectBranchPage && location.includes('branch')) {
